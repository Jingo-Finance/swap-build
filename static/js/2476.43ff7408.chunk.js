...
`,P=(0,m.default)(k.DA).withConfig({displayName:"v2__ButtonRow",componentId:"sc-55c62c67-3"})`
  ...
  `};
`,U=(0,m.default)(g.DF).withConfig({displayName:"v2__ResponsiveButtonPrimary",componentId:"sc-55c62c67-4"})`
  height: 40px;
  width: fit-content;
  border-radius: 12px;
  ${({theme:e})=>e.deprecated_mediaWidth.deprecated_upToSmall`
    width: 48%;
  `};
`,L=(0,m.default)(g.PL).withConfig({displayName:"v2__ResponsiveButtonSecondary",componentId:"sc-55c62c67-5"})`
  height: 40px;
  width: fit-content;
  ${({theme:e})=>e.deprecated_mediaWidth.deprecated_upToSmall`
    width: 48%;
